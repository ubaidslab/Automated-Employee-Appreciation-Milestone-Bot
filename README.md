...
- **Two critical advisories in that same set, named precisely rather than lumped in above:**
  ...
  - [CVE-2026-75604](https://github.com/advisories/GHSA-p293-qw3h-jr36) (CVSS 9.0) — a
    ...
    semantics. This app's documented deployment target is Vercel, which runs on Linux-based
    serverless infrastructure, so this one doesn't apply here; it's listed for completeness, not
    left unmentioned because it sounds inconvenient.
